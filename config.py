...
# ------------------------------------------------
API_ID = int(os.environ.get("API_ID", "31375087"))
# ------------------------------------------------
API_HASH = os.environ.get("API_HASH","f232b9d0117f9d058d0e5d7fc4a6dd83")
# ------------------------------------------------
...
# ------------------------------------------------
# //LOG CHANNEL ID 
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1004411643684"))

# //FORCE_CHANNEL_ID
CHANNEL_ID2 = int(os.environ.get("CHANNEL_ID2", "-1004411643684")) 
# ------------------------------------------------
MONGO_URL = os.environ.get("MONGO_URL", "mongodb+srv://gurjarpapla498_db_user:11JKk8sD0Ng4GXpy@cluster0.dfpojps.mongodb.net/?appName=Cluster0")
# -----------------------------------------------
PREMIUM_LOGS = int(os.environ.get("PREMIUM_LOGS", "-1004411643684"))
# -----------------------------------------------
join = '<a href="https://t.me/Sankiworld28">✳️ JOIN BACKUP</a>'
# -----------------------------------------------
